...
description: Privacy policy for Dream Weaver
created_at: 2025-10-24
---

## Introduction

Welcome to Dream Weaver (梦境造物主), an **AI-powered personalized picture book platform** for children. At Dream Weaver, your privacy is of utmost importance to us, and this privacy policy outlines how we collect, use, and protect your personal information when you use our services (including photos, voice samples, and account data).

## Information Collection and Use

We collect the following types of data to provide you with a better experience while using Dream Weaver:
...
2. **Usage Details**
   - **What We Collect**: Information about how you use Dream Weaver, including your interactions, features accessed, and usage frequency.
   - **Purpose**: To analyze user engagement and improve our services.

3. **Device Information**
   - **What We Collect**: Data regarding the devices you use to access Dream Weaver, such as device type, operating system, and browser type.
...
**Copyright Owner**: [aiaudiotools.shop](https://aiaudiotools.shop)
**Email**: [support@aiaudiotools.shop](mailto:support@aiaudiotools.shop)

By using Dream Weaver, you consent to our privacy policy and agree to its terms. Thank you for trusting us with your information!
